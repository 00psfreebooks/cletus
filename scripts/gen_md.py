    ...
    for json_file in json_files:
        ...
        for website, articles in daily_links.items():
            ...
            for index, article in enumerate(articles, start=1):
                ...
                # Check if headline and link are valid and unique in the current markdown content - some duplicate links might be on the same website at the same time before recorded in history
